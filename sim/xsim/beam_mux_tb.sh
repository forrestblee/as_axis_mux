...
#
# Script generated by Vivado on Tue May 28 22:38:10 -0700 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : beam_mux_tb.sh
...
#
# Usage        : beam_mux_tb.sh
#                beam_mux_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                beam_mux_tb.sh [-reset_run]
#                beam_mux_tb.sh [-reset_log]
#                beam_mux_tb.sh [-help]
#
...
# script info
echo -e "beam_mux_tb.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./beam_mux_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot beam_mux_tb xil_defaultlib.beam_mux_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim beam_mux_tb -key {Behavioral:sim_1:Functional:beam_mux_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb beam_mux_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./beam_mux_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: beam_mux_tb.sh [-help]\n\
Usage: beam_mux_tb.sh [-step]\n\
Usage: beam_mux_tb.sh [-lib_map_path]\n\
Usage: beam_mux_tb.sh [-reset_run]\n\
Usage: beam_mux_tb.sh [-reset_log]\n\
Usage: beam_mux_tb.sh [-keep_index]\n\
Usage: beam_mux_tb.sh [-noclean_files]\n\n\
